...
*/
-- DropForeignKey
ALTER TABLE "case_documents" DROP CONSTRAINT "case_documents_userId_fkey";

-- DropForeignKey
ALTER TABLE "case_events" DROP CONSTRAINT "case_events_userId_fkey";

-- DropForeignKey
ALTER TABLE "case_messages" DROP CONSTRAINT "case_messages_userId_fkey";
